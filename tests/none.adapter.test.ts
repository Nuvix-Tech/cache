...
describe('None Adapter', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle undefined parameters gracefully', async () => {
      await expect(adapter.load(undefined as any, undefined as any)).resolves.toBe(false);
      await expect(adapter.save(undefined as any, undefined as any)).resolves.toBe(false);
